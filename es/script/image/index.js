...
var PuiImage = function PuiImage(props) {
  ...
  var imgRef = useRef(null); // 判断元素是否在可视区
  ...
  var isInViewPort = function isInViewPort() {
    ...
    return (
      ((_imgRef$current = imgRef.current) === null || _imgRef$current === void 0
        ? void 0
        : (_imgRef$current$getBo = _imgRef$current.getBoundingClientRect()) ===
            null || _imgRef$current$getBo === void 0
        ? void 0
        : _imgRef$current$getBo.top) <=
      viewPortHeight + 100
    );
  };
