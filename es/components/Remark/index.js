...
var RemarkText = function RemarkText(props) {
      ...
      if ((words === null || words === void 0 ? void 0 : words.length) > 0) {
        words.forEach(function (item) {
          ...
          if (key === 'line') {
            ...
            tempText = tempText.replace(reg, "<font color=\"#ffffff\" style=\"background-color: ".concat(colorHight[key], ";\">").concat(item, "</font>"));
          }
        });
      }
    });
        ...
        if ((words === null || words === void 0 ? void 0 : words.length) > 0) {
          words.forEach(function (item) {
            ...
            if (key === 'line') {
              ...
              tempText = tempText.replace(reg, "<font color=".concat(colorHight16[key], ">").concat(item, "</font>"));
            }
          });
        }
      });
  ...
  }, "\u9AD8", ' '), /*#__PURE__*/React.createElement("button", {
    className: "hight-btn",
    type: "button",
    style: {
      background: '#F59A23'
  ...
  }, "\u4F4E", ' '), /*#__PURE__*/React.createElement("button", {
    className: "hight-btn",
    type: "button",
    style: {
      background: '#8400FF'
  ...
  }, "\u98CE", ' '), /*#__PURE__*/React.createElement("button", {
