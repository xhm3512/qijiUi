...
export default function (props) {
  ...
  var _useState = useState(BraftEditor.createEditorState(tempValue || '', {
    editorId: id
  })),
  ...
  if (type === 'textArea') {
    ...
    }, maxLength ? "".concat(currentTextLength) : ''), maxLength ? "/".concat(maxLength) : ''), /*#__PURE__*/React.createElement(BraftEditor, _objectSpread(_objectSpread({}, aaa), {}, {
      maxLength: true,
