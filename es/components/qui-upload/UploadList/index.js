...
var listItemMotion = _objectSpread({}, collapseMotion);
...
var InternalUploadList = function InternalUploadList(_ref, ref) {
  ...
  var actionIconRender = function actionIconRender(customIcon, callback, prefixCls, title) {
    ...
    if (isValidElement(customIcon)) {
      var btnIcon = cloneElement(customIcon, _objectSpread(_objectSpread({}, customIcon.props), {}, {
  ...
  }, /*#__PURE__*/React.createElement(CSSMotionList, _objectSpread(_objectSpread({}, motionConfig), {}, {
    component: false
  }), function (_ref2) {
    var key = _ref2.key,
        file = _ref2.file,
  ...
  }), appendAction && /*#__PURE__*/React.createElement(CSSMotion, _objectSpread(_objectSpread({}, motionConfig), {}, {
