...
import DownloadOutlined from '@ant-design/icons/DownloadOutlined'; // import Progress from '../../progress';
...
var ListItem = /*#__PURE__*/React.forwardRef(function (_ref, ref) {
  ...
  var listContainerNameClass = classNames("".concat(prefixCls, "-list-").concat(listType, "-container"), className); // const item =
  //   file.status === 'error' ? (
