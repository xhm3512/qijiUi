...
var Drawer = function Drawer(_ref) {
  ...
  var classessDialog = classNames("".concat(prefixCls, "-dialog"), (_classNames = {}, _defineProperty(_classNames, "".concat(prefixCls, "-dialog_show"), visible), _defineProperty(_classNames, "".concat(prefixCls, "-dialog_hidden"), !visible), _classNames));
  var classessMask = classNames("".concat(prefixCls, "-mask"), (_classNames2 = {}, _defineProperty(_classNames2, "".concat(prefixCls, "-mask-show"), visible), _defineProperty(_classNames2, "".concat(prefixCls, "-mask-hidden"), !visible), _classNames2));
  useEffect(function () {
    if (visible) {
      onDialogOpen();
    } else {
