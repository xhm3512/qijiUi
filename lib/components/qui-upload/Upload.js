...
exports.default = exports.UploadContext = void 0;
...
var UploadContext = /*#__PURE__*/(0, React.createContext)({});
...
var InternalUpload = function InternalUpload(props, ref) {
  ...
  var mergedBeforeUpload = /*#__PURE__*/function () {
    ...
    return function mergedBeforeUpload(_x2, _x3) {
  ...
  var _React$useContext = React.useContext(_context2.ConfigContext),
  ...
  if (type === 'drag') {
    var _classNames;
    var dragCls = (0, _classnames.default)(prefixCls, (_classNames = {}, _defineProperty(_classNames, "".concat(prefixCls, "-drag"), true), _defineProperty(_classNames, "".concat(prefixCls, "-drag-uploading"), mergedFileList.some(function (file) {
    ...
    return /*#__PURE__*/React.createElement("span", null, /*#__PURE__*/React.createElement(UploadContext.Provider, {
      value: passedContext
      ...
      style: style
    }, /*#__PURE__*/React.createElement(_rcUpload.default, _objectSpread(_objectSpread({}, rcUploadProps), {}, {
      ref: upload,
  ...
  var uploadButtonCls = (0, _classnames.default)(prefixCls, (_classNames2 = {}, _defineProperty(_classNames2, "".concat(prefixCls, "-select"), true), _defineProperty(_classNames2, "".concat(prefixCls, "-disabled"), disabled), _classNames2));
  var renderUploadButton = function renderUploadButton(uploadButtonStyle) {
    return /*#__PURE__*/React.createElement(UploadContext.Provider, {
      value: passedContext
    }, /*#__PURE__*/React.createElement("div", {
