...
var _quiCol = _interopRequireDefault(require("../qui-col"));
...
var Foo = function Foo(_ref) {
  ...
  var _useState = (0, _react.useState)(currentActive),
    _useState2 = _slicedToArray(_useState, 2),
    activeIndex = _useState2[0],
    setActiveIndex = _useState2[1];
  // item样式
  var classesItem = function classesItem(index) {
    return (0, _classnames.default)("".concat(prefixCls, "-item"), _defineProperty({}, "".concat(prefixCls, "-active"), index === activeIndex && active));
  };
  // 点击item高亮
  ...
  return /*#__PURE__*/_react.default.createElement(_quiRow.default, {
    ...
    return /*#__PURE__*/_react.default.createElement(_quiCol.default, {
      key: i,
      style: {
        padding: '0 8px'
      }
