...
exports.default = exports.PuiCol = void 0;
 ...
 * ~~~
 */
var PuiCol = function PuiCol(props) {
  ...
  var classes = (0, _classnames.default)('pui-col', _defineProperty({}, "pui-col-".concat(span), span), className); // 判断  flex 是否是数字  判断flex是否是字符串  判断flex是否是 复合类型 1 1 200px
