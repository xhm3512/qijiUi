                  ...
                  for (
                    ...
                    if (!(A instanceof r)) {
                      var _,
                        T = 1;
                      if (y) {
                        if (((_ = i(S, w, e, h)), !_ || _.index >= e.length))
                          break;
                        var I = _.index,
                        ...
                        if (
                          ((x -= v.value.length), (w = x), v.value instanceof r)
                        )
                          continue;
                        for (
                          var O = v;
                          O !== t.tail &&
                          (x < R || 'string' === typeof O.value);
                          O = O.next
                        )
                          T++, (x += O.value.length);
      ...
      (r.default = r),
        ...
        (function(e) {
          ...
          function u(t) {
            ...
            if (3 === i.length) {
              var s = [1, 1];
              s.push.apply(s, l(i[1], e.languages.javascript, 'javascript')),
                i.splice.apply(i, s);
            }
