        ...
        w = function(e, t, n) {
          var r = function() {
              for (
                ...
                n[r] = arguments[r];
              for (
                var a = n[0].navs[n[1]] || [], l = '*', o = a.length - 1;
                o >= 0;
                o -= 1
              ) {
                var c = a[o],
                  ...
                  i.length > 2
                    ? r.createElement(
                        'select',
                        {
                          value: c,
                          onChange: function(e) {
                            return l.m8.push(s(e.target.value));
                          },
                        },
                        i.map(function(e) {
          ...
          return (
            ...
            r.createElement(
              ...
              r.createElement(
                ...
                0 === i.length &&
                  n &&
                  r.createElement('li', { style: { textAlign: 'center' } }, m),
              ),
            )
          );
        };
      ...
      var R = function(e) {
        ...
        W = function(e) {
          var t,
            ...
            N = A && m.hero,
            M = A && m.features,
            L = !1 !== m.sidemenu && !N && !M && !m.gapless,
            C =
              !N &&
              !M &&
              Boolean(
                null === (t = m.slugs) || void 0 === t ? void 0 : t.length,
              ) &&
